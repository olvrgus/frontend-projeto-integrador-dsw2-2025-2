      ...
      <div className="container text-start">
        ...
        <div className="card w-100 mx-auto" style={{ width: "18rem" }}>
          <div className="card-body">
            <h5 className="card-title">Disco: *Som da Rua*</h5>
            <h6 className="card-subtitle mb-2 text-body-secondary">Artista: DJ Cria</h6>
            <p className="card-text">
              Um clássico do rap nacional com batidas marcantes e letras que contam a vida nas ruas.
              Lançado em 2022, esse disco traz a essência da quebrada com muito estilo.
            </p>
            <div class="d-flex ">
